  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 selection:bg-orange-500 selection:text-white antialiased overflow-hidden py-12">
      ...
      <div className="fixed inset-0 w-full h-full -z-10 pointer-events-none">
        ...
        <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-[radial-gradient(circle,rgba(249,115,22,0.08)_0%,transparent_70%)] rounded-full blur-[80px]"></div>
      </div>
      ...
      <div className="w-full max-w-md bg-[color:var(--bg-card)]/70 backdrop-blur-xl border border-[color:var(--border)] p-8 sm:p-10 rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] relative z-10">
        ...
        <p className="text-sm text-[color:var(--text-muted)] font-light mb-8">
          Join thousands mastering their wealth. No credit card required.
        </p>
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <iconify-icon icon="solar:user-linear" className="text-[color:var(--text-subtle)] text-lg"></iconify-icon>
              </div>
              <input 
                type="text" 
                required 
        ...
        <p className="text-[10px] text-center text-[color:var(--text-subtle)] mt-4 px-4 leading-relaxed">
          By signing up, you agree to our <a href="#" className="underline hover:text-[color:var(--text-muted)]">Terms of Service</a> and <a href="#" className="underline hover:text-[color:var(--text-muted)]">Privacy Policy</a>.
        </p>
        ...
        <div className="mt-8 text-center pt-6 border-t border-[color:var(--border)]/50">
          <p className="text-xs text-[color:var(--text-muted)] font-light">
            ...
            <a href="/login" className="ml-2 text-[color:var(--text)] hover:text-[color:var(--accent)] font-medium transition-colors">
              Log in instead
            </a>
          </p>
        </div>
