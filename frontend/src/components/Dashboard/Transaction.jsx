              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-white/5">
                  {filteredTransactions.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="text-center py-16 text-sm text-gray-600 font-mono italic">-- NO DATA FOUND --</td>
                    </tr>
                  ) : (
                      ...
                      <tr key={t.id} className="hover:bg-white/[0.03] transition-colors group">
                        <td className="px-10 py-6 flex items-center gap-4">
                          <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center transition-all group-hover:border-orange-500/30">
                            <Icon icon="solar:wad-of-money-bold-duotone" className="text-2xl text-orange-500/70 group-hover:text-orange-500 transition-all duration-300" />
                          </div>
                          <span className="text-sm font-medium group-hover:text-orange-500 transition-colors">{t.description || t.category}</span>
                        </td>
                        <td className="px-10 py-6 text-center">
                          <span className="text-[10px] font-mono text-gray-400 bg-white/5 border border-white/10 px-3 py-1 rounded-full uppercase">{t.category}</span>
                        </td>
